...
CON_INAC   = float(getenv("SWAYFADER_CON_INAC", 0.6))    # inactive window
FLOAT_AC   = float(getenv("SWAYFADER_FLOAT_AC", 1))      # active floating window
FLOAT_INAC = float(getenv("SWAYFADER_FLOAT_INAC", 0.6)) # inactive floating window
BOT_INAC   = float(getenv("SWAYFADER_BOT_INAC", 0.92))    # bottom window
